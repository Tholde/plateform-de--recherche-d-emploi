			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | Manage RH</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
									...
									<tbody>
										<tr>
											...
											<div class="visible-md visible-lg hidden-sm hidden-xs">
													<a href="<?= base_url('editRh').'/'.$row['id'] ?>" class="btn btn-transparent btn-xs"
														tooltip-placement="top" tooltip="Edit"><i
															class="fa fa-pencil"></i></a>

													<a href="<?= base_url('deleteRh').'/'.$row['id'] ?>"
