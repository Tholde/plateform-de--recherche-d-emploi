	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				<h2>JSS | RH Registration</h2>
			</div>
			<?php $validation = \Config\Services::validation(); ?>
			<!-- start: REGISTER BOX -->
			<div class="box-register">
				<form name="registration" id="registration" method="post" action="<?= base_url('/registration') ?>"
					...
					<fieldset>
						...
						<div class="form-group">
							<input type="text" class="form-control" name="society" placeholder="Address" required>
							<?php if ($validation->getError('society')): ?>
								<div class="alert alert-danger">
									<?= $validation->getError('society'); ?>
								</div>
							<?php endif ?>
						</div>
						<div class="form-group">
